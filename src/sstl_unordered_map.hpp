#ifndef _SSTL_UNORDERED_MAP_H
#define _SSTL_UNORDERED_MAP_H
...
private:
  ...
  typedef sup::hashtable<Key, std::pair<Key, Value>, HashFunc, 
    std::_Select1st<std::pair<Key, Value>>, EqualKey, Alloc> container_type;
  container_type ht; 
...
public: 
  ...
  unordered_map(size_type n, const hasher& hf): ht(n, hf, key_equal()) {}
  unordered_map(size_type n, const hasher& hf, const key_equal& eq)
    : ht(n, hf, eq) {}
